...
export default function VerticalTabs() {
  ...
  const fetchCoinMarketData = (coinId) => {
    ...
    fetch(`https://api.coingecko.com/api/v3/coins/${coinId}/market_chart?vs_currency=inr&days=200`, options)
  ...
  useEffect(() => {
    ...
    fetch('https://api.coingecko.com/api/v3/coins/markets?vs_currency=inr&category=layer-1', options)
      .then(response => response.json())
      .then(data => {
        setCoinDetails(data);
        setLoading(false);
